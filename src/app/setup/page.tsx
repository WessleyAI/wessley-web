  ...
  const renderStep = (stepNum: number) => {
    switch (stepNum) {
      ...
      case 1:
        return (
          <StepContainer
            stepDescription="Let's create your Wessley profile."
            stepNum={currentStep}
            stepTitle="Welcome to Wessley - Your Vehicle Assistant"
      ...
      case 2:
        return (
          <StepContainer
            stepDescription="Enter API keys for AI services (optional - you can skip this step)."
            stepNum={currentStep}
      ...
      case 3:
        return (
          <StepContainer
            stepDescription="Ready to start working on your vehicle projects!"
            stepNum={currentStep}
