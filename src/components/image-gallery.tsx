...
import { Eye, Trash2, MoreVertical, Calendar, FileImage } from 'lucide-react'
import { useUploadStore } from '@/stores/upload'
import { ImagePreview } from './image-preview'

export function ImageGallery() {
  const { images, removeImage, setCurrentImage, currentImageId } = useUploadStore()
              ...
              <div className="p-4">
                ...
                <div className="mt-4 flex space-x-2">
                  ...
                  {image.status === 'uploaded' && (
                    <button className="px-3 py-2 text-sm bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition-colors font-medium">
                      Analyze
                    </button>
                  )}
                </div>
